...
const sections = [
  ...
  ["5. Hosting, performance telemetry and recipients", <p key="h">Technical service providers may process limited data on our behalf for hosting, security, communications and business operations. The website uses Vercel Speed Insights to measure aggregated web performance. Depending on the request context, this may include route information, device and browser characteristics, country-level location and web-vital measurements. We use this telemetry for our legitimate interests in maintaining a stable, secure and performant public website. Data is disclosed only where necessary, contractually protected or legally required.</p>],
  ...
  ["11. Changes", <p key="u"><strong>Effective date: 5 August 2026 · Version 1.1</strong><br />We may update this notice when processing activities, services or legal requirements change. The current version is published on this page.</p>],
] as const;
  ...
  return (
    <main className="legal-page">
      ...
      <section className="legal-hero">
        <div className="section-kicker light">PRIVACY / VERSION 1.1</div>
        ...
        <div className="legal-meta"><span>Effective 5 August 2026</span><span>GDPR</span><span>Logik Systems OOD</span></div>
      </section>
